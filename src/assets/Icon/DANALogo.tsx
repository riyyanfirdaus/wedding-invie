const DANALogo = () => {
  return (
    <svg width="68px" height="68px" xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 382 109.22">
      <defs>
        <style
          dangerouslySetInnerHTML={{
            __html: ".cls-1,.cls-2{fill:#008ceb;}.cls-1{fill-rule:evenodd;}.cls-3{fill:#fefefe;}",
          }}
        />
      </defs>
      ...
      />
      <circle className="cls-2" cx="54.61" cy="54.61" r="54.61" />
      <path
        className="cls-3"
